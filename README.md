...
Keep in mind, after running the scripts, specifically _changePrice.js_, you may need to restart your ganache cli, and re-migrate contracts to properly retest.
